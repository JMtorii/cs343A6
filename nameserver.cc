...
NameServer::NameServer( Printer &prt, unsigned int numVendingMachines, unsigned int numStudents ) : 
    ...
    vendingMachines = new VendingMachines*[ numVendingMachines ];
...
void NameServer::VMregister( VendingMachine *vendingmachine ) {
    ...
    prt.print( Printer::NameServer, ( char ) REGIST_VENDING_MACHINE, machId );
...
void NameServer::main() {
    ...
    for ( ;; ) {
        ...
        or _When ( numRegVendingMachines == numMachines ) _Accept ( getMachine, getMachineList );
        or _When ( numRegVendingMachines < numMachines ) _Accept ( VMregister );
    }
